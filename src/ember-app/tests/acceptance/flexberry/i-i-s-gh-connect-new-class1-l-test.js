...
moduleForAcceptance('[AGAT] Acceptance | i i s gh connect new class1 l');

test('testing i-i-s-gh-connect-new-class1-l', function(assert) {
  visit('/i-i-s-gh-connect-new-class1-l');
